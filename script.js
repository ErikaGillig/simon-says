...
class Simon {
    ...
    // Actualiza la ronda y tablero
    updateRound(value) {
        this.round = value;
        this.display.round.textContent = `Round ${this.round}`;
    }

    // Crea lo aleatorio de botones
    createSequence() {
    ...
    // activa una función cuando se hace clickea un botón
    buttonClick(value) {
        !this.blockedButtons && this.validateChosenColor(value);
    }

    // Valida si el boton que toca el Usuario es el correcto
    ...
    // Muestra los botones a clickear
    showSequence() {
        this.blockedButtons = true;
        let sequenceIndex = 0;
